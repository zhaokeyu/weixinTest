...
var p9UI = (function(_super) {
	function p9UI() {

		this.p9 = null;

		p9UI.__super.call(this);
	}

	CLASS$(p9UI, 'ui.test.p9UI', _super);
	var __proto__ = p9UI.prototype;
	__proto__.createChildren = function() {

		laya.ui.Component.prototype.createChildren.call(this);
		this.createView(p9UI.uiView);
	}
	STATICATTR$(p9UI, ['uiView', function() {
		return this.uiView = {
			"type": "View",
			"props": {
				"width": 640,
